...
superseded_by: [ADR-001, ADR-002, ADR-003, ADR-004, ADR-005, ADR-006, ADR-007, ADR-008, ADR-009, ADR-010, ADR-011, ADR-012, ADR-013, ADR-014, ADR-015, ADR-016, ADR-017, ADR-018]
note: "v1 表格式决策记录，已拆为 docs/decisions/ADR-NNN-*.md。保留作历史归档"
---
...
> - REV 检视清单包含"模式一致性"维度（详见 `docs/reviews/架构审查-重复代码与抽象质量.md` §6.2）
...
详见 `docs/reviews/架构审查-重复代码与抽象质量.md` §4 整改清单。
