"""neoconstruct vs Python construct 2.10.70 Struct 性能基准测试（B1-B7）。

组件：bench/_helpers/runner.py（BenchRunner）。

7 个用例（B1-B7），每个测 parse + build，对照 neoconstruct vs Python construct 2.10.70。
...
def main():
    parser = argparse.ArgumentParser(description="neoconstruct Struct 性能基准测试")
    ...
    print("=" * 70)
    print("neoconstruct vs Python construct 2.10.70 Struct 性能基准测试")
    print("=" * 70)
