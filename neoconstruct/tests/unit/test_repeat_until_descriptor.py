...
from neoconstruct._descriptors import RepeatUntilDescriptor
from neoconstruct import Int8ub, CompilationError
...
def test_terminator_stored_correctly():
    ...
    from neoconstruct import rfield, Element
...
def main():
    ...
    from neoconstruct._descriptors import (
        RepeatUntilDescriptor as _RUD,
    )
    from neoconstruct import Int8ub as _I8
    from neoconstruct import CompilationError as _CE
