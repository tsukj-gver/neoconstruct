...
from neoconstruct._mixin import _FieldDescriptor, _ExprRef

# 检查 Rust 扩展是否可用
try:
    from neoconstruct import StructMixin, field  # noqa: F401
...
class TestExplicitSelectError:
    ...
    def test_explicit_error_class_exists(self):
        ...
        # 继承自 ConstructError
        from neoconstruct import ConstructError
...
class TestSwitchDescriptor:
    ...
    def test_constructor_rejects_callable(self):
        ...
        from neoconstruct import CompilationError
...
class TestEndToEndFocusedSeq:
    ...
    def test_basic_parse_returns_focus_field(self):
        ...
        from neoconstruct import StructMixin, field
        from neoconstruct import Bytes
