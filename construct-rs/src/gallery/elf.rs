...
/// Creates a `Box<dyn Construct>` for an unsigned integer field of the given
/// endianness and width.
fn int_field(endian: Endianness, kind: FormatKind) -> Box<dyn Construct> {
    Box::new(FormatField::new(endian, kind))
}
            ...
            .field(
                ...
                Box::new(IfThenElse::new(
                    ...
                    Box::new(IfThenElse::new(
                        ...
                        Box::new(body(Endianness::Little, true)),
                        Box::new(body(Endianness::Little, false)),
                    )),
                    ...
                    Box::new(IfThenElse::new(
                        ...
                        Box::new(body(Endianness::Big, true)),
                        Box::new(body(Endianness::Big, false)),
                    )),
                )),
            ),
    )
