...
pub fn msdosheader() -> Struct {
    Struct::new()
        ...
        .field("lfanew", Box::new(Pointer::new(0x3C, Box::new(INT16UL))))
}
...
pub fn coffheader() -> Struct {
    Struct::new()
        .field(
            "signature",
            Box::new(Const::new_bytes(b"PE\x00\x00".to_vec())),
        )
        .field(
            "machine",
            Box::new(Enum::new(
...
pub fn datadirectory() -> Struct {
    Struct::new()
        .field(
            "name",
            Box::new(Computed::new(Box::new(compute_datadirectory_name))),
        )
...
fn plusfield() -> Box<dyn Construct> {
    ...
    Struct::new()
        ...
        .field(
            ...
            Box::new(ArrayExpr::new(
                Box::new(ConstExpr::new(Value::UInt(2))),
                Box::new(INT8UL),
            )),
        )
...
pub fn section() -> Struct {
    Struct::new()
        ...
        .field(
            "rawdata",
            Box::new(PointerExpr::new(
                Box::new(this_().field("rawdata_pointer")),
                Box::new(BytesExpr::new(Box::new(CondExpr::new(
                    this_()
...
pub fn pe32file() -> Box<dyn Construct> {
    Box::new(
        Struct::new()
            ...
            .anonymous(Box::new(SeekExpr::new(Box::new(
                this_().field("msdosheader").field("lfanew"),
            ))))
            ...
            .field(
                ...
                Box::new(If(
                    Box::new(|ctx: &Context| {
                        ctx.get_path(&["coffheader".to_string(), "optionalheader_size".to_string()])
                            .ok()
                            .and_then(|v| v.to_u64().ok())
                            .map(|v| v > 0)
                            .unwrap_or(false)
            ...
            .field(
                "sections_count",
                Box::new(Computed::new(Box::new(compute_sections_count))),
            )
            .field(
                "sections",
                Box::new(ArrayExpr::new(
