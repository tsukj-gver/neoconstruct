...
- (3) harness/MEMORY.md 组件清单'规范来源'列被启动时读 ✓（评估 2 引用）
...
- iter6 manifest: `harness/manifests/change_2026-07-27-iter6-workflow-integration.json`
- iter5 manifest verification 关闭: `harness/manifests/change_2026-07-27-iter5-evaluate-step.json`
