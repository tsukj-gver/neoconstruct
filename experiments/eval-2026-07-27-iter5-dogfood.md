...
| 4 | `read` (manifests/* 4 份) + `read` (MEMORY.md / experiences.md / SKILL.md) | 收集 evidence | 必要 |
...
- **模式分类**: 工具环境问题，非 harness 缺陷——**不进入 experiences.md**
...
- **根因**:
  1. MEMORY.md Harness 组件清单未标注规范来源——PM 无法一眼看出 AUDITOR 是项目自定义
...
- MEMORY.md 三处更新（组件清单加规范来源 / AHE 历史加 iter5 / 教训索引加 L-08）
...
- iter5 manifest: `manifests/change_2026-07-27-iter5-evaluate-step.json`
- L-08 教训: `experiences.md §L-08`
- §C / §D 协议: `construct-rs-ahe-practices/SKILL.md`
- iter4 verification 关闭: `manifests/change_2026-07-27-skill-iteration-lessons.json`
